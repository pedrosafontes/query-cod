...
export const joinOperators: RAKeyboardItem[] = [
  ...
  },
  {
    ...
    details: {
      ...
      description:
        "Returns all tuples from the left relation, matching tuples from the right relation, and fills with nulls where there is no match.",
      args: [
        { name: "R", description: "Left-hand relation" },
        { name: "S", description: "Right-hand relation" },
      ],
  ...
  },
  {
    ...
    details: {
      ...
      description:
        "Returns all tuples from the right relation, matching tuples from the left relation, and fills with nulls where there is no match.",
      args: [
        { name: "R", description: "Left-hand relation" },
        { name: "S", description: "Right-hand relation" },
      ],
  ...
  },
  {
    ...
    details: {
      ...
      description:
        "Returns all tuples from both relations, matching them where possible, and fills with nulls where there is no match.",
      args: [
        { name: "R", description: "Left-hand relation" },
        { name: "S", description: "Right-hand relation" },
      ],
