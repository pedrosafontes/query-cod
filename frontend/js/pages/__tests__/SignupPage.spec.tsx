...
describe("SignupPage", () => {
  ...
  test("shows validation errors when fields are empty", async () => {
    ...
    expect(
      await screen.findByText(/confirmation is required/i),
    ).toBeInTheDocument();
  ...
  test("calls authUsersCreate, logs in and navigates on successful signup", async () => {
    renderComponent();
  ...
  test("shows an error when signup fails", async () => {
    (AuthService.authUsersCreate as jest.Mock).mockRejectedValueOnce(
